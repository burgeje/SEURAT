 ...
 */
public abstract class CandidateRationaleEditorBase extends EditorPart 
	implements IPartListener
{
	 ...
	 */
	public CandidateTreeParent saveNew() {
		//////////////////////////////////////////////
		// ---> Get Necessarry Data From Logical File
		CandidateRationaleExplorer explorer;
		explorer = (CandidateRationaleExplorer)getEditorInput().getAdapter(CandidateRationaleExplorer.class);
		
		RationaleElement parentElement;
		parentElement = (RationaleElement)getEditorInput().getAdapter(RationaleElement.class);
		
		CandidateTreeParent parentTree;
		parentTree = (CandidateTreeParent)getEditorInput().getAdapter(CandidateTreeParent.class);

		CandidateTreeParent newEle = explorer.createUpdate(parentTree, getRationaleElement());
		return newEle;
	}
	...
	public void saveExisting() {
		...
		((CandidateRationaleEditorInput)getEditorInput()).setCandidateTreeParent(parentTree);
	}
	...
	public void doSave(IProgressMonitor monitor) {	
		try
		{
			...
			if (saveOK) {
				if( isCreating() ) {
					CandidateTreeParent p = saveNew();
					getEditorData().setCreated();
					getEditorData().setCandidateTreeParent(p);
	 ...
	 */
	public CandidateRationaleEditorInput getEditorData() {
		return (CandidateRationaleEditorInput)getEditorInput();
	}
	/**
	 ...
	 */
	public CandidateRationaleExplorer getExplorer() {
		return (CandidateRationaleExplorer)getEditorData().getAdapter(RationaleElement.class);
	}
	/**
	 ...
	 */
	public CandidateTreeParent getTreeParent() {
		return (CandidateTreeParent)getEditorData().getAdapter(CandidateTreeParent.class);
	}
	...
	public void init(IEditorSite site, IEditorInput input)
		...
		if (!(input instanceof CandidateRationaleEditorInput))
			throw new PartInitException("Invalid Input: Must be CandidateRationaleEditorInput");
		CandidateRationaleEditorInput l_input = (CandidateRationaleEditorInput)input;
