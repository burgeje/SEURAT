...
public class EditPattern extends NewRationaleElementGUI {
...
//				if(ourPattern.getName() == nameField.getText())
//				{
...
//							RationaleDB.getRationaleElement(ourPattern.getName(), RationaleElementType.PATTERN);
//						RationaleUpdateEvent evt = new RationaleUpdateEvent(this);
//						evt.fireUpdateEvent(ele, ourDisplay, UpdateType.UPDATE);
//						shell.close();
//						shell.dispose();
//					}
